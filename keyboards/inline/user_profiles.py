...
def get_user_profile(user_id):
    ...
    msg = f"<b>📱 Ваш профиль:</b>\n" \
          ...
          f"➖➖➖➖➖➖➖➖➖➖➖➖➖\n" \
          f"💳 Баланс: <code>{get_user[4]}₽</code>\n" \
          f"🛍 Заработано с реф-ов: <code>{get_user[7]}₽</code>\n"\
          f"💙 Количество реф-ов: <code>{get_user[9]}</code>\n" \
          f"💵 Всего пополнено: <code>{get_user[5]}₽</code>\n" \
          f"🎁 Куплено товаров: <code>{count_items}</code>"
    return msg
