...
input_kb = InlineKeyboardButton(text="💵 Пополнить QIWI", callback_data="user_input")
...
start_inn.add(InlineKeyboardButton(text="📘 Канал с новостями и разчами", url="https://t.me/smoke_software"))
